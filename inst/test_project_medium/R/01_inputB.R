...
##
## this is a medium project, so there are already several data sources
## to be read

## but this one is already in R
load("RData_input1.RData")
load("RData_input1.RData")              # should one be once, but lets
                                        # see what happens
## load("RData_input2.RData") # this is commented, so it should not be relevant


## --------------------
##
## here comes a lot of R-code from the package
## just to see if some bogus stuff ends up in the Makefile
##
## --------------------
...
##
## now export something!
library(rio)
export("Data/partB.RData")
